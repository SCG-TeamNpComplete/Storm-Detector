...
public class JsonCreation {
	...
	public JsonCreation() {
		System.out.println();
		System.out.println("Creating object to dump to DB");
		...
		try {
			...
			/*
			 * obj.put("userId", "soumya"); obj.put("reqId",10);
			 * obj.put("serviceId", "StormDetection"); obj.put("text",
			 * "test text, we can put some data here. May be KML output");
			 */
			System.out.println("Object createds");
		} catch (Exception e) {
		...
		WebTarget target1 = client1
				.target("http://ec2-35-160-137-157.us-west-2.compute.amazonaws.com:8080/SG_MICROSERVICE_REGISTRY/gateway")
